...
public class Seat {
	...
	/*
	 * Der Konstruktor hat den Preis nicht, weil wir den erst nachträglich
	 * hinzufügen (nachdem wir beim Preisdienst waren)
	 * 
	 * Einen zweiten Konstruktor zu bauen verwirrt JSON bei implizieter
	 * Konvertierung
	 * 
	 * Den hier brauchen wir für auslesen aus der Datenbank, also nehmen wir
	 * erstmal den, würde ich vorschlagen
	 */
